...
<div class="wrapper">
	...
	<section class="main-controls">
		...
		<div id="buttons">
			<button class="record" on:click={record} bind:this={recordButton}>Record</button>
...
<aside>
	...
	<p>
		Web dictaphone is built using <a
			href="https://developer.mozilla.org/en-US/docs/Web/API/Navigator.getUserMedia">getUserMedia</a
		>
		and the
